...
sealed trait SqlRepBase[S, R, T, G] {
  ...
  def order[K](isDefaultDesc: Boolean)(implicit columnGen: R <:< Rep[K], wtImplicit: Rep[K] => ColumnOrdered[K]): this.type
...
trait SqlRep[S, R, T, G] extends SqlRepBase[S, R, T, G] {
  ...
  override def order[K](isDefaultDesc: Boolean)(implicit columnGen: R <:< Rep[K], wtImplicit: Rep[K] => ColumnOrdered[K]): this.type = {
