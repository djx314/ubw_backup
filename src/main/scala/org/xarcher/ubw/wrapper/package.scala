...
package object wrapper {
  ...
  implicit class miaolegemiRepExtensionMethod[S1, R1](repLike: S1 => R1) {
    ...
    def as_ext[T1 : WeakTypeTag, G1](columnName: String)(implicit shape1: Shape[_ <: FlatShapeLevel, R1, T1, G1], jsonEncoder1: Encoder[T1]): SqlRep[S1, R1, T1, G1] = {
  ...
  implicit class miaolegemiRepExtensionMethod1111[R1](repLike: R1) {
    ...
    def as[T1 : WeakTypeTag, G1](columnName: String)(implicit shape1: Shape[_ <: FlatShapeLevel, R1, T1, G1]): SqlRep[Any, R1, T1, G1] = ???
